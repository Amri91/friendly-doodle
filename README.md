...
This is a collection of tests that will call the online website. I'll try to keep the website up as long as possible. You can change the url from the environment variables.
